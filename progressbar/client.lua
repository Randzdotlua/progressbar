...
if Debug then
    RegisterCommand('prog', function()
        Core.Functions.Progressbar('nameofprog', 'What the player sees', 3000, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true
            }, {}, {}, {}, function()
               Core.Functions.Notify('You finished the progress bar', 'success')
                -- This code runs if the progress bar is completed
                -- You can add your own logic here
            end, function()
                Core.Functions.Notify('You cancelled the progress bar', 'error')
                -- This code runs if the progress bar is cancelled
                -- You can add your own logic here
        end)
    end)
end